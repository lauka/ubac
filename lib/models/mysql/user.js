	...
	*/
	...
	var sql_get = 'SELECT id, name, mobile, email, audit FROM rbac_user WHERE ?',
		sql_add = 'INSERT INTO rbac_user SET ?',
		sql_set = 'UPDATE rbac_user SET ? WHERE ?',
		sql_del = 'DELETE FROM rbac_user WHERE ?';
