	...
	*/
	...
	var sql_get = 'SELECT * FROM rbac_resource',
		sql_add = 'INSERT INTO rbac_resource SET ?',
		sql_set = 'UPDATE rbac_resource SET ? WHERE ?',
		sql_del = 'DELETE FROM rbac_resource WHERE ?';
