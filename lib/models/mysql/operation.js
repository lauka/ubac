	...
	*/
	...
	var sql_get = 'SELECT * FROM rbac_operation',
		sql_add = 'INSERT INTO rbac_operation SET ?',
		sql_set = 'UPDATE rbac_operation SET ? WHERE ?',
		sql_del = 'DELETE FROM rbac_operation WHERE ?';
